                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    ...
                    @if (session()->has('user'))
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a href="/logout"><button class="me-3 login-btn btn btn-outline-success" class="button"
                                    id="form-open"><i class="fa-solid fa-arrow-right-from-bracket"></i> LOGOUT</button></a>
                                <a href="/single" class="dropdown-item">Blog Detail</a>
                                <a href="/destinationpage" class="dropdown-item">Destination</a>
                                <a href="/guide" class="dropdown-item">Travel Guides</a>
                                <a href="/testimonial" class="dropdown-item">Testimonial</a>
                    ...
                    @else
                        <a href="/login"><button class="login-btn btn btn-outline-success" class="button"
                                id="form-open"><i class="fa-solid fa-arrow-right-from-bracket"></i> LOGIN</button></a>
                    @endif
                </div>
            </nav>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="{{$item->category_pic}}" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="/bycat{{$item->category_name}}">
                            <h5 class="text-white">{{$item->category_name}}</h5>
